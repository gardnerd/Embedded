...
#define I2C_WRITE_DATA 0x9
#define I2C_WRITE_ADDR 0xA
#define I2C_END_WRITE 0xB
#define I2C_ACK 0xC
#define I2C_REP_START 0xD
...
unsigned char i2c_master_send(unsigned char, unsigned char, unsigned char *, unsigned char);
